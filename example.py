...
documents = [
    {
        'title': 'Andy Warhol',
        'body': '''Andy Warhol was an American artist, film director, and
        producer who was a leading figure in the visual art movement known as
        pop art.'''

    },
    {
        'title': 'LeBron James',
        'body': '''LeBron Raymone James Sr. is an American professional
    ...
    {
        'title': 'Jeff Bezos',
        'body': '''Jeffrey Preston Bezos is an American internet entrepreneur,
        industrialist, media proprietor, and investor. He is best known as the
        founder, CEO, and president of the multi-national technology company
        Amazon.'''
    }
]
